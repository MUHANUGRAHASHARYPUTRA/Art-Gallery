        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden">
                    ...
                    @if ($stats['pending_curators'] > 0)
                        <a href="{{ route('admin.users') }}"
                            class="text-xs font-bold text-red-500 hover:underline mt-2 block">Action Needed</a>
                    @endif
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <a href="{{ route('admin.categories') }}"
                    class="group bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition duration-300">
                    <div
                        class="w-14 h-14 bg-indigo-50 text-indigo-600 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-indigo-600 group-hover:text-white transition">
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Create, edit, or delete artwork categories to keep
                        the platform organized.</p>
                </a>

                <a href="{{ route('admin.users') }}"
                    class="group bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition duration-300">
                    <div
                        class="w-14 h-14 bg-purple-50 text-purple-600 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-purple-600 group-hover:text-white transition">
                        <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Manage user roles and approve new curator
                        applications.</p>
                </a>
                ...
                <a href="{{ route('admin.moderation') }}"
                    class="group bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition duration-300">
                    <div
                        class="w-14 h-14 bg-red-50 text-red-600 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-red-600 group-hover:text-white transition">
                        <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Review reported content and take action to maintain
                        safety.</p>
                </a>
