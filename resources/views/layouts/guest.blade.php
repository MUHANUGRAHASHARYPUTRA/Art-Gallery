    ...
    <div class="min-h-screen flex bg-white">
        ...
        <div class="hidden lg:block lg:w-1/2 relative overflow-hidden bg-black">
            <img src="https://images.unsplash.com/photo-1579783902614-a3fb39279c0f?w=1600&q=80"
                class="absolute inset-0 h-full w-full object-cover opacity-80" data-aos="zoom-out"
                data-aos-duration="1500">

            <div
                class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex flex-col justify-end p-16">
                <h2 class="text-white text-5xl font-black tracking-tighter mb-4" data-aos="fade-up"
                    data-aos-delay="300">Inspire & <br>Be Inspired.</h2>
                <p class="text-gray-300 text-lg" data-aos="fade-up" data-aos-delay="500">Join the world's most vibrant
                    community of digital artists and creators.</p>
            </div>
        </div>
